...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      console.log('🔐 Invio form login...', email)
      ...
      console.log('➡️ Redirect a dashboard (il profilo verrà caricato lì)')
      
      // Redirect IMMEDIATO con window.location per forzare il reload completo
      // Questo forza un caricamento fresco della dashboard che caricherà il profilo
